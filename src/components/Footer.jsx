    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-content">
          <div className="footer-brand">
            <Link to="/" className="footer-logo">
              <img src="/logo.png" alt="Launchpad Prep" className="footer-logo-image" />
            </Link>
          ...
          <div className="footer-links">
            ...
            <div className="footer-column">
              ...
              <Button to="/apply" variant="outline-gold" size="small">
                Send Inquiry
              </Button>
            </div>
          </div>
        ...
        <div className="footer-bottom">
          <p>&copy; {new Date().getFullYear()} Launchpad Prep. All rights reserved.</p>
          <div className="footer-universities">
            <span>Our mentors come from:</span>
            <span className="universities">Stanford, Harvard, MIT, Yale, Princeton, Columbia, UPenn, Duke</span>
          </div>
        </div>
      </div>
    </footer>
